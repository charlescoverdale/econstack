...
**Only stop to ask the user when:** programme details are missing, evidence quality is unclear, or outcome monetisation requires user judgment.
**Never stop to ask about:** discount rate (use STPR), decay rate defaults, unit cost database selection, or additionality rates (use HMT defaults).
