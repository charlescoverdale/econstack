...
Reviews any economic analysis output against methodology standards and practitioner best practice. Works on CBA reports, business cases, RIA documents, fiscal briefings, macro briefings, or any document making economic claims with numbers.
...
/econ-audit bc-hospital-obc-2026-04-10.md --strict
/econ-audit . --fix
/econ-audit ria-climate-disclosure-2026-04-10.md --framework eu-brg
```
...
- `cba-*.md`, `type: cost-benefit` → CBA
- `bc-*.md`, `type: business-case` → Business case
- `ria-*.md`, `type: ria` → RIA
- `longlist-*.md`, `type: longlist` → Longlist
- `mca-*.md`, `type: mca` → MCA
- `io-*.md`, `type: io-report` → IO impact
...
- **Markdown (.md)**: always generated. `audit-[target-slug]-[date].md`.
