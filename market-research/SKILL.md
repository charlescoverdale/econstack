...
- `/io-report` provides the regional economic impact for investments in the sector.
- `/cost-benefit` and `/business-case` can use this skill's market sizing as input to a sector investment appraisal.
