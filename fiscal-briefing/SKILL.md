...
- **Table and figure formatting (universal across all econstack outputs):**
  ...
  - **Notes line**: Below the source, if needed: "Notes: [caveats, e.g. 'real 2026 prices', '2024-25 outturn', 'OBR forecast']."
  ...
  - **Number formatting**: Currency with comma separators and 1 decimal place for millions (e.g. "GBP 45.2m"), whole numbers for counts, percentages to 1 decimal place (e.g. "3.5%").
