...
**Only stop to ask the user when:** country is ambiguous, or the user requests a non-standard fiscal indicator.
**Never stop to ask about:** data sources (use the best available), section selection when --full is specified, or fiscal rule definitions.
